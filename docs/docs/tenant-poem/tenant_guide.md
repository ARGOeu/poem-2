...
**Step 1:** Go to [administration page](administration/tenant_administration.md).
...
**Step 4:** Name the group and optionally add resources to it. Details are described in [groups of resources documentation](administration/tenant_groups_of_resources.md#sections).
