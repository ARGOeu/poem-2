...
## Adding users
**Step 1:** Go to [Administration page](super-admin-poem/administration/superadmin_administration.md).

**Step 2:** Select **Users** in **Authentication and Authorization** section.

**Step 3:** Click the `Add` button in [users page](super-admin-poem/administration/superadmin_users.md#list-of-users).

**Step 4:** Fill in the necessary fields before hitting `Save` button. The fields are described in [users documentation](super-admin-poem/administration/superadmin_users.md#user-details).
