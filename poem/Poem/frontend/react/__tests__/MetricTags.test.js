...
describe("Test metric tags changeview", () => {
  ...
  test("Test that page renders properly", async () => {
    ...
    expect(await table.findByText("argo.AMS-Check")).toBeInTheDocument()
    expect(await table.findByText("argo.AMSPublisher-Check")).toBeInTheDocument()
  ...
  test("Test import csv successfully", async () => {
    ...
    expect(await table.findByText("generic.certificate.validity")).toBeInTheDocument()
    expect(await table.findByText("generic.http.connect")).toBeInTheDocument()
    expect(await table.findByText("generic.tcp.connect")).toBeInTheDocument()
  ...
  test("Test import csv with nonexisting metrics", async () => {
    ...
    expect(await table.findByText("argo.AMS-Check")).toBeInTheDocument()
    expect(await table.findByText("argo.AMSPublisher-Check")).toBeInTheDocument()
    expect(await table.findByText("mock.metric.name")).toBeInTheDocument()
