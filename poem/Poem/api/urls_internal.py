...
urlpatterns = [
    ...
    path('aggregations/<str:aggregation_apiid>', views_internal.ListAggregations.as_view(), name='aggregations'),
    path('public_aggregations/<str:aggregation_apiid>', views_internal.ListPublicAggregations.as_view(), name='aggregations'),
    ...
    path('metricprofiles/<str:profile_apiid>', views_internal.ListMetricProfiles.as_view(), name='metricprofiles'),
    path('public_metricprofiles/<str:profile_apiid>', views_internal.ListPublicMetricProfiles.as_view(), name='metricprofiles'),
    ...
    path('public_services/', views_internal.ListPublicServices.as_view(), name='services'),
    ...
    path('thresholdsprofiles/<str:profile_apiid>', views_internal.ListThresholdsProfiles.as_view(), name='thresholdsprofiles'),
    path('public_thresholdsprofiles/<str:profile_apiid>', views_internal.ListPublicThresholdsProfiles.as_view(), name='thresholdsprofiles'),
