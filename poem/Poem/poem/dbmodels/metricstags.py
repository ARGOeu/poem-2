...
class ProbeCandidate(models.Model):
    ...
    submitted_sent = models.BooleanField(default=False)
    testing_sent = models.BooleanField(default=False)
    deployed_sent = models.BooleanField(default=False)
    rejected_sent = models.BooleanField(default=False)
    processing_sent = models.BooleanField(default=False)
